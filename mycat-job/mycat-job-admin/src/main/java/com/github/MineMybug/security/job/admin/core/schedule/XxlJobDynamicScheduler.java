package com.github.MineMybug.security.job.admin.core.schedule;
...
import com.github.MineMybug.security.core.biz.AdminBiz;
import com.github.MineMybug.security.core.biz.ExecutorBiz;
import com.github.MineMybug.security.core.enums.ExecutorBlockStrategyEnum;
import com.github.MineMybug.security.core.rpc.netcom.NetComClientProxy;
import com.github.MineMybug.security.core.rpc.netcom.NetComServerFactory;
import com.github.MineMybug.security.job.admin.core.jobbean.RemoteHttpJobBean;
import com.github.MineMybug.security.job.admin.core.model.XxlJobInfo;
import com.github.MineMybug.security.job.admin.core.thread.JobFailMonitorHelper;
import com.github.MineMybug.security.job.admin.core.thread.JobRegistryMonitorHelper;
import com.github.MineMybug.security.job.admin.core.util.I18nUtil;
import com.github.MineMybug.security.job.admin.dao.XxlJobGroupDao;
import com.github.MineMybug.security.job.admin.dao.XxlJobInfoDao;
import com.github.MineMybug.security.job.admin.dao.XxlJobLogDao;
import com.github.MineMybug.security.job.admin.dao.XxlJobRegistryDao;
...
public final class XxlJobDynamicScheduler implements ApplicationContextAware {
    ...
    public void init() throws Exception {
        // admin registry monitor run   “执行器管理功能”通过守护线程去刷新在线机器
	...
	public static void fillJobInfo(XxlJobInfo jobInfo) {
        ...
        try {
			...
			if (trigger!=null && trigger instanceof CronTriggerImpl) {
				...
				jobInfo.setUpdateTime(((CronTriggerImpl) trigger).getNextFireTime());
			}
