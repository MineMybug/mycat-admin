package com.github.MineMybug.security.job.admin.core.thread;
...
import com.github.MineMybug.security.job.admin.core.util.MailUtil;
					...
					try {
						...
						if (CollectionUtils.isNotEmpty(jobLogIdList)) {
							for (Integer jobLogId : jobLogIdList) {
								...
								} else if (IJobHandler.SUCCESS.getCode() == log.getHandleCode()) { //调度与执行任务都成功
									// job success, pass
